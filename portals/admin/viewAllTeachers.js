...
function getEmploymentBadge(status) {
    const map = {
        ...
        resigned: { label: 'Resigned', className: 'status-pill--resigned' },
        terminated: { label: 'Terminated', className: 'status-pill--terminated' },
    };
    ...
    teachers.forEach(teacher => {
        ...
        const row = `
            <tr class="student-row">
                ...
                <td class="student-status">${getEmploymentBadge(teacher.employment_status || 'active')}</td>
                <td class="student-actions-cell">
                    <div class="student-action-stack">
                        <button class="view-btn" type="button" data-type="teacher" data-id="${teacher.teacher_id}">View</button>
                        <div class="student-menu">
                            <button class="student-menu-toggle" type="button" aria-label="Open teacher actions">⋮</button>
