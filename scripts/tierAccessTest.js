...
class TierAccessTest {
    ...
    async testRouteAccess() {
        ...
        const routes = [
            { path: '/studentsPortal', tier: TIERS.STUDENT_ENGAGEMENT, name: 'Student Portal' },
            { path: '/cbt', tier: TIERS.STUDENT_ENGAGEMENT, name: 'CBT Exams' },
            { path: '/parentsPortal', tier: TIERS.FULL_CONNECT, name: 'Parent Portal' },
            { path: '/ai', tier: TIERS.FULL_CONNECT, name: 'AI Assistants' },
            { path: '/schoolAdmin', tier: TIERS.ADMIN_CORE, name: 'School Admin' },
            { path: '/teachersPortal', tier: TIERS.ADMIN_CORE, name: 'Teacher Portal' }
        ];
